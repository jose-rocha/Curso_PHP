<nav class="modulos">
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=api&file=desafio_imagens">Desafio Imagens - Respostas</a></li>
        </ul>
    </div>
    <div class="modulo vermelho">
        <h3>12. Sessão & Cookie</h3>
        <ul>
            <li><a href="exercicio.php?dir=sessao&file=basico_sessao">Sessão - Básico Sessão</a></li>
            <li><a href="exercicio.php?dir=sessao&file=basico_sessao_alterar">Sessão - Alterar Sessão</a></li>
            <li><a href="exercicio.php?dir=sessao&file=basico_sessao_limpar">Sessão - Limpar Sessão</a></li>
        </ul>
    </div>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes&file=required_return">Require & Return</a></li>
            <li><a href="exercicio.php?dir=includes&file=include_once">Include & Reqquire</a></li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=funcoes&file=usando_tipos">Declarando Tipos</a></li>
            ...
            <li><a href="exercicio.php?dir=funcoes&file=busca_recursiva">Busca Recursiva</a></li>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=variaveis&file=desafio_variaveis_variaveis">safio Variáveis Variáveis</a></li>
            <li><a href="exercicio.php?dir=variaveis&file=valor_referencia">lor vs Referência</a></li>
            <li><a href="exercicio.php?dir=variaveis&file=constantes">nstantes</a></li>
        </ul>
    </div>
    <div class="modulo vermelho">
        <h3>2. Tipos</h3>
        <ul>
            ...
            <li><a href="exercicio.php?dir=tipos&file=boolean">Tipo Booleano</a></li>
