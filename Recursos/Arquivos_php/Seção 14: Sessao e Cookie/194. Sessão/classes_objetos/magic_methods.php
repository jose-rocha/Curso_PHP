...
class Pessoa {
  ...
  public function __call($metodo, $params)  {
    ...
    echo ", com os parâmetros: <br>";
    print_r($params);
  }

}

$pessoa = new Pessoa('José', 31); // __construct
$pessoa->apresentar(); // chamando o __toString
echo $pessoa, '<br>'; // chamando o __toString
$pessoa->nome = 'Reinaldo';
$pessoa->apresentar(); // chama diretamente sem o __call

$pessoa->nomeCompleto = 'Muito legal!'; // __set
$pessoa->nomeCompleto; // __get
echo $pessoa->nome; // acessa p atributo diretamente sem __get

$pessoa->exec(1, 'teste', true, [1, 2, 3]); /* __call
serve para ser chamado quando o método não existe. */
